const CACHE='sky-lens-pwa-v1.3.0';
const ASSETS=['./','./index.html','./styles-v1.3.css','./app-v1.3.js','./manifest.webmanifest','./icon.svg','./src/astronomy.js','./src/catalog.js','./src/simbad.js','./src/constellations.js','./src/solar-system.js'];
